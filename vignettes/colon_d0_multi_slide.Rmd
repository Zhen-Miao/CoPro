---
title: "Gene-space multi-slide example (Colon Day 0)"
output: rmarkdown::html_vignette
date: "2026-07-29"
vignette: >
  %\VignetteIndexEntry{Gene-space multi-slide example (Colon Day 0)}
...
For new multi-sample analyses, start with the
[recommended PC-space SUMCOR workflow](multi_sample_workflow.html), which
includes numerical convergence and conditioning diagnostics.

This vignette retains the **gene-space CCA** example and its gene-space
figures. `runGeneSpaceCCA()` works directly on expression, with per-slide
centering and scaling. Its SUMCOR iteration uses a frozen-denominator
surrogate: a converged fixed point need not be stationary for the ratio
objective. The full-gradient PC-space guarantee does not apply to this
solver. The displayed results illustrate the gene-space alternative.
...
![plot of chunk plot-celltype](figures/colon_d0_multi_slide-plot-celltype-1.png)
...
![plot of chunk insitu-cc1](figures/colon_d0_multi_slide-insitu-cc1-1.png)
...
fibroblast score --- the association visualizes the pattern fitted on these slides.
...
![plot of chunk cross-corr](figures/colon_d0_multi_slide-cross-corr-1.png)
...
![plot of chunk top-genes-cc1](figures/colon_d0_multi_slide-top-genes-cc1-1.png)

## Cross-slide consistency

Since each slide comes from a different tissue region, we inspect how the fitted
gene-space CCA scores vary across slides.
...
![plot of chunk per-slide-dist](figures/colon_d0_multi_slide-per-slide-dist-1.png)
...
![plot of chunk per-slide-corr](figures/colon_d0_multi_slide-per-slide-corr-1.png)
