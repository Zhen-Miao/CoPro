...
# #' @noRd
# optimize_bilinear_slides_one <- function(X_list_all, K_list_all,
#                                                     max_iter = 1000, tol = 1e-5,
#                                                     n_cores = 1) {

#   n_slides <- length(X_list_all)
#   if (n_slides < 2) {
#     stop("Use optimize_bilinear_One for a single slide.")
#   }
...
# #'   as a single-column matrix.
# #' @noRd
# optimize_bilinear_slides_one_iter <- function(X_list_all, K_list_all,
#                                          max_iter = 1000, tol = 1e-5,
#                                          n_cores = 1) {
...
# #'
# #' Used within optimize_bilinear_n_slides_one. Iteratively refines a weight
...
# #' @noRd
# optimize_bilinear_n_slides_one <- function(X_list_all, K_list_all, w_list,
#                                            nCC = 2,
#                                            max_iter = 1000,
#                                            tol = 1e-5) {
