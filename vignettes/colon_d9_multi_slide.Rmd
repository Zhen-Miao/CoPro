...
![plot of chunk plot-celltype](figures/colon_d9_multi_slide-plot-celltype-1.png)
...
![plot of chunk ref-results](figures/colon_d9_multi_slide-ref-results-1.png)
...
![plot of chunk mu-boxplot](figures/colon_d9_multi_slide-mu-boxplot-1.png)
...
**Note:** The results below are based on a single slide and may not fully
reflect the patterns reported in the manuscript, which analyzed all Day 9
slides jointly. For a more comprehensive analysis, please refer to the
manuscript. The full dataset is available at
...
![plot of chunk celltype-prop](figures/colon_d9_multi_slide-celltype-prop-1.png)
...
![plot of chunk plot-transfer](figures/colon_d9_multi_slide-plot-transfer-1.png)
...
![plot of chunk transfer-mu-spatial](figures/colon_d9_multi_slide-transfer-mu-spatial-1.png)
...
`(slide, cell type)` block before fitting one shared PCA loading matrix, then
combine slides with equal-slide SUMCOR. Thus the low-dimensional coordinates
are shared without letting between-slide offsets or variances choose the PC
subspace or dominate the CoPro objective.
