# Extracted from test-pca-workflow.R:494
...
no_flip(base@cellScores, nudged@cellScores, "cellScores")
no_flip(base@geneScores, nudged@geneScores, "geneScores")
no_flip(base@geneScoresRegression, nudged@geneScoresRegression,
          "geneScoresRegression")
expect_equal(
    do.call(rbind, base@normalizedCorrelation)$normalizedCorrelation,
    do.call(rbind, nudged@normalizedCorrelation)$normalizedCorrelation,
    tolerance = 1e-8
  )
